...
apt-get -q update
apt-get -y -qq install nginx libevent-dev postgresql python-psycopg2 python-setuptools python-imaging python-lxml python-numpy rsync build-essential subversion git-core unzip zip curl wget redis-server runit mercurial
